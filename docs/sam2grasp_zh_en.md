...
> **文档说明：** 由 [`sam2grasp.pdf`](sam2grasp.pdf) 抽取并整理为 Markdown，再做成**段落级中英对照**。  
> 图用 PDF 截图/内嵌图导出后插入（见 `assets/sam2grasp/`）；表格与公式已转写为 Markdown。  
> **arXiv:** [2512.02609](https://arxiv.org/abs/2512.02609)（cs.RO，2025-12-02）
