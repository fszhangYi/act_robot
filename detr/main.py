...
def get_args_parser():
    ...
    parser.add_argument('--ckpt_dir', action='store', type=str, help='ckpt_dir', default='')
    parser.add_argument('--policy_class', action='store', type=str, help='policy_class, capitalize', default='ACT')
    parser.add_argument('--task_name', action='store', type=str, help='task_name', default='task')
...
def build_ACT_model_and_optimizer(args_override):
    ...
    args = parser.parse_args([])  # use defaults; args_override applied below
